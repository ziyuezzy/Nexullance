...
def main():
    ...
    filename = f'data_Slimfly_MP_ASP.csv'
...
def profile(config: tuple, traffic_pattern: str, _shift: int):
    ...
    # pickle.dump(weighted_path_dict, open(f"./picked_path_dicts/Nexullance_MP_ASP_Slimfly_{config[0]}_{config[1]}_{traffic_pattern}_{_shift}.pkl", "wb"))
