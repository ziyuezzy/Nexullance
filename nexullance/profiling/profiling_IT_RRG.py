...
def main():
    ...
    with open(filename, 'a', newline='') as csvfile:
        ...
        csvwriter.writerow(['V', 'D', 'traffic_pattern', 'Lremote_MAX_ECMP', 'Llocal_MAX_ECMP', 'Phi_ECMP[Gbps]', 
                            'Lremote_NEXU_IT', 'Phi_NEXU_IT[Gbps]', 'method1_times[s]', 'method1_peak_RAMs[MB]', 'method1_results[Gbps]',
...
def profile(config: tuple, traffic_pattern: str, _shift: int):
    ...
    2, 4, weighted_method_1, weighted_method_2)
