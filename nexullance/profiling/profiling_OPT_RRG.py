...
def main():
    ...
    with open(filename, 'a', newline='') as csvfile:
        ...
        csvwriter.writerow(['V', 'D', 'traffic_pattern', 'Lremote_MAX_ECMP_ASP', 'Llocal_MAX_ECMP_ASP', 'Phi_ECMP_ASP[Gbps]', 'Lremote_NEXU_OPT', 'Phi_NEXU_OPT[Gbps]', 'init_time[s]', 'solving_time[s]', 'peak_RAM[MB]'])
