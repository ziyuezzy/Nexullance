...
# from Nexullance_MP_MP_APST4 import Nexullance_MP_MP_APST4
...
# this is a script to profile Nexullance_MP_MP_APST4
# objectives: 
...
def main():
    ...
    with open(filename, 'a', newline='') as csvfile:
        ...
        csvwriter.writerow(['V', 'D', 'traffic_pattern', 'Lremote_MAX_ECMP_APST4', 'Llocal_MAX_ECM_APST4', 'Phi_ECMP_APST4[Gbps]', 'Lremote_NEXU_MP_APST4', 'Phi_NEXU_MP_APST4[Gbps]', 'init_time[s]', 'solving_time[s]', 'peak_RAM[MB]'])
...
def profile(config: tuple, traffic_pattern: str, _shift: int):
    ...
    ECMP_MP_APST4_Phi=gl.network_total_throughput(M_EPs, max_remote_link_load, max_local_link_load)
    ...
    return [max_remote_link_load, max_local_link_load, ECMP_MP_APST4_Phi, Lremote_NEXU_MP_MP_APST4, Phi_NEXU_MP_MP_APST4, middle_time - start_time, end_time - middle_time, peak_RAM]
