...
from nexullance.Nexullance_IT_gt import Nexullance_IT_gt
...
def main():
    ...
    nexu_it = Nexullance_IT_gt(_network.nx_graph, M_R, Cap_remote)
    profiler = cProfile.Profile()
    profiler.enable()

    _, _ = nexu_it.optimize(1, alpha_1, beta_1, 6, alpha_2, beta_2, config[0])
