...
import numpy as np
from Nexullance_HPCA_data_gen.perturbations_abs.perturbate_abs import perturbate_abs
    ...
    with open(filename, 'w', newline='') as csvfile:
        ...
        for V, D in configs:
            ...
            def calculate_results(_traffic_pattern, _M_EPs):
                ...
                nexu.init_model()
                max_remote_link_load, result_RT = nexu.solve()
                ...
                for perturbation_ratio in np.arange(0.01, 0.5, 0.01):
                    ...
                    for i in range(num_repetitions):
                        ...
                        perturbed_M_EPs = perturbate_abs(_M_EPs, perturbation_ratio)
